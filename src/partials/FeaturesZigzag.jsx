      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <div className="inline-flex text-sm font-semibold py-1 px-3 m-2 bg-aqela-purple-text text-purple-200 rounded-full mb-4">
              Empowering you to achieve what's important
            </div>
            <h1 className="h2 mb-4">One product, unlimited solutions</h1>
            <p className="text-xl text-gray-400">
              Whether you need to streamline your business processes, increase efficiency, or enhance customer
              experience, our versatile product provides unlimited solutions tailored to your unique needs.
            </p>
          </div>
          ...
          <div className="grid gap-20">
            ...
            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
              ...
              >
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  ...
                  <h3 className="h3 mb-3">Organization</h3>
                  ...
                  <ul className="text-lg text-gray-400 -mb-2">
                    ...
                    <li className="flex items-center mb-2">
                      ...
                      <span>Strategic foresight and intentional execution</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
              ...
              >
                <div className="md:pl-4 lg:pl-12 xl:pl-16">
                  ...
                  <h3 className="h3 mb-3">Cutting edge technologies</h3>
                  <p className="text-xl text-gray-400 mb-4">
                    By leveraging cutting-edge technologies, we empower businesses to stay ahead of the curve and drive
            ...
            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
              ...
              >
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  <div className="font-architects-daughter text-xl text-aqela-purple-text mb-2">More speed. Less spend</div>
