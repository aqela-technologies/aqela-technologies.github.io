          ...
          <nav className="hidden md:flex md:grow">
            ...
            <li>
              ...
              {/* <li>
                <Link
                  to="/signin"
                  className="font-medium text-aqela-purple hover:text-gray-200 px-4 py-3 flex items-center transition duration-150 ease-in-out"
                >
                  Sign in
                </Link>
              </li>
            ...
            >
              <ul className="bg-gray-800 px-4 py-2">
                ...
                {/* <li>
                  <Link
                    to="/signin"
                    className="flex font-medium w-full text-aqela-purple hover:text-gray-200 py-2 justify-center"
                  >
                    Sign in
                  </Link>
                </li>
